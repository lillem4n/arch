...
pacstrap /mnt base base-devel grub-efi-x86_64 efibootmgr dialog wpa_supplicant xorg xorg-xinit i3 i3lock i3status dmenu bash-completion openssh nano git terminator xterm leafpad chromium
